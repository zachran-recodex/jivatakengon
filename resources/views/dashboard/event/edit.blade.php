        ...
        <div class="w-full mx-auto sm:px-6 lg:px-8">
            <div class="pb-4 flex justify-between">
                <x-dashboard-breadcrumb :links="[
                    ...
                    ['label' => 'Facility', 'url' => route('admin.event.index')],
                    ['label' => $event->title],
                    ['label' => 'Edit']
                ]" />

                <a href="{{ route('admin.event.index') }}" class="border border-gray-200 rounded-lg bg-blue-500 hover:bg-blue-700 text-white font-bold py-3 px-5">
                    Back
                </a>
            </div>
                ...
                <div class="px-6 py-4">
                    ...
                    <form action="{{ route('admin.event.update', $event) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-4 flex items-center justify-between gap-4">
                            ...
                            @if($event->image)
                                <div class="w-full">
                                    <img src="{{ asset('storage/' . $event->image) }}" alt="{{ $event->title }}" class="w-full h-64 border object-cover rounded">
                                </div>
                            @endif
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <select name="is_active"
                                ...
                                <option value="0" {{ old('is_active', $event->is_active) == 0 ? 'selected' : '' }}>Disable</option>
                            </select>
                        </div>
